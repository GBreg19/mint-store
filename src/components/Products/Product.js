...
const Product = ({ item, data, setData }) => {
  ...
  return (
    <div className="w-full max-w-sm bg-white border border-gray-200 hover:bg-gray-100 duration-1000 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 relative pt-5">
